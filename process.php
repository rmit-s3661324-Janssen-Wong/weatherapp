...
<html>
	<head>
				...
				<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
					...
					<body>
						...
						<div class="container">
							<div id='header'>
								<h1>Weather for
									<?php echo htmlspecialchars($_GET['city'])?> is:
								</h1>
							</div>
							<?php
		...
		$request->setQuery("SELECT state, year, mo as month, da as date, max as maxTemperature, min as minTemperature, visib as visibility, wdsp as windspeed, prcp as rainpercent
				FROM [bigquery-public-data:noaa_gsod.gsod2019] AS st LEFT OUTER JOIN [weatherapp001:weatherdataset.weatherinfo] AS bigtable ON stn=usaf
		...
		$userid = $_SESSION['login_userId'];
	 	$handle = fopen('gs://weatherapp001/userInput '.date("Y-m-d h:i:sa").'.txt','w');
